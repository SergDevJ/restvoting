...
<script src="resources/js/restaurants.js" defer></script>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="detailsForm">
          ...
          <div class="form-group">
            <label for="email" class="col-form-label"><spring:message code="restaurant.email"/></label>
            <input type="email" class="form-control" id="email" name="email"
                   placeholder="<spring:message code="restaurant.email"/>">
          </div>

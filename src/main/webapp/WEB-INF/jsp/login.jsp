    ...
    <div class="container">
        ...
        <sec:authorize access="isAnonymous()">
            <div class="pt-2">
                ...
                <button type="submit" class="btn btn-lg btn-primary mt-2" onclick="login('User1', '2222')">
                    <spring:message code="app.login"/> User1
                </button>
                <button type="submit" class="btn btn-lg btn-primary mt-2" onclick="login('User2', '3333')">
                    <spring:message code="app.login"/> User2
                </button>
                <button type="submit" class="btn btn-lg btn-primary mt-2" onclick="login('Admin', '1111')">
